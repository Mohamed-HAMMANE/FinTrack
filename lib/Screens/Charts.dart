                                ...
                                titlesData: FlTitlesData(
                                  bottomTitles: AxisTitles(
                                    sideTitles: SideTitles(
                                      showTitles:
                                          true, // Keep the X-axis values
                                      reservedSize: 30,
                                      interval: 1,
                                      getTitlesWidget: (value, meta) {
                                        int index = value.toInt();
                                        if (index >= 0 &&
                                            index < incMonths.length) {
                                          return Text(
                                            incMonths[index],
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Wrap(
                              spacing: 12,
                              runSpacing: 8,
                              children: _categoryBreakdown.asMap().entries.map((
                                entry,
                              ) {
                                final index = entry.key;
                                final data = entry.value;
                            ...
                            AspectRatio(
                              ...
                              child: LineChart(
                                LineChartData(
                                      ...
                                      sideTitles: SideTitles(
                                        ...
                                        getTitlesWidget: (value, meta) {
                                          ...
                                          if (index >= 0 &&
                                            ...
                                            final month =
                                                _savingsTrend[index]['Month'];
                                            // Show every 3rd month or first/last
                                            if (index % 3 == 0 ||
                                                index ==
                                                    _savingsTrend.length - 1) {
                                              return Padding(
                                                padding: const EdgeInsets.only(
                                                  top: 8,
                                                ),
                                  ...
                                  lineBarsData: [
                                    LineChartBarData(
                                      spots: _savingsTrend.asMap().entries.map((
                                        entry,
                                      ) {
                                        return FlSpot(
                                          entry.key.toDouble(),
